...
rm -f ./../../../target/extensions/CSGOStats.Infrastructure.Validation*.nupkg && 
	...
	dotnet nuget push ./../../../target/extensions/CSGOStats.Infrastructure.Validation*.nupkg -k b8e0f6c7-0f8d-3d80-83dc-eccb59ee6083 --skip-duplicate -n true -t 30 -s http://localhost:8081/repository/nuget-default/
